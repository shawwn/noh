...
// Definitions
//=============================================================================
DEFINE_ENT_ALLOCATOR2(State, GroupHeal);
//=============================================================================


/*====================
  CStateGroupHeal::CEntityConfig::CEntityConfig
  ====================*/
CStateGroupHeal::CEntityConfig::CEntityConfig(const tstring &sName) :
IEntityState::CEntityConfig(sName),
INIT_ENTITY_CVAR(HealthPerSecond, 60.0f)
{
}


/*====================
  CStateGroupHeal::CStateGroupHeal
  ====================*/
CStateGroupHeal::CStateGroupHeal() :
...
/*====================
  CStateGroupHeal::StateFrame
  ====================*/
void	CStateGroupHeal::StateFrame()
{
...
/*====================
  CStateGroupHeal::Expired
  ====================*/
void	CStateGroupHeal::Expired()
{
