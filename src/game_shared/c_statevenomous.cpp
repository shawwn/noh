...
#include "c_statevenomous.h"
//=============================================================================

//=============================================================================
// Definitions
//=============================================================================
DEFINE_ENT_ALLOCATOR2(State, Venomous)
//=============================================================================


/*====================
  CStateVenomous::CEntityConfig::CEntityConfig
  ====================*/
CStateVenomous::CEntityConfig::CEntityConfig(const tstring &sName) :
...
/*====================
  CStateVenomous::StateFrame
  ====================*/
void	CStateVenomous::StateFrame()
{
