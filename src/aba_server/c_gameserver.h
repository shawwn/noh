...
private:
    ...
    map<int, float>         m_mapPlayerRatings;
    map<int, uint>          m_mapPlayerWins;
    map<int, uint>          m_mapPlayerLosses;
    map<int, uint>          m_mapPlayerDisconnects;
    map<int, uint>          m_mapPlayerKills;
    map<int, uint>          m_mapPlayerAssists;
    map<int, uint>          m_mapPlayerDeaths;
    map<int, float>         m_mapPlayerEmPercent;
    map<int, float>         m_mapPlayerExpMin;
    map<int, float>         m_mapPlayerGoldMin;
    map<int, uint>          m_mapPlayerAccountType;
    map<int, uint>          m_mapPlayerTrialStatus;
    map<int, uint>          m_mapPlayerTrialCount;
...
public:
    ...
    void            Reset(bool bFailed = false);
    void            EndFrame(PoolHandle hSnapshot);

    void            BalanceTeams(bool bAutoBalanceMode = false);
    ...
    bool            SelectHero(int iClientNumber, ushort unHero, bool bPotentialHero);
    ...
    void    LogAward(EGameLogEvent eEvent, IUnitEntity *pAttacker, IUnitEntity *pTarget)                                        { m_GameLog.WriteAward(eEvent, pAttacker, pTarget); }
