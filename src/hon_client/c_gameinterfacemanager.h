...
const int MAX_ALT_AVATAR_LIST(6);
...
enum EGameUITrigger
{
    ...
    UITRIGGER_TMM_GAME_PHASE,
    UITRIGGER_LAG,
    UITRIGGER_STATS_STATUS,
    ...
    UITRIGGER_ALT_INFO_0_ITEMS,
    UITRIGGER_ALT_INFO_0_SHIELD,
    UITRIGGER_ALT_INFO_0_MAX_SHIELD,
    UITRIGGER_ALT_INFO_0_SHIELD_PERCENT,
    UITRIGGER_ALT_INFO_0_IS_IN_EXP_RANGE,
    ...
    UITRIGGER_ALT_INFO_1_SHIELD,
    UITRIGGER_ALT_INFO_1_MAX_SHIELD,
    UITRIGGER_ALT_INFO_1_SHIELD_PERCENT,
    UITRIGGER_ALT_INFO_1_IS_IN_EXP_RANGE,
    ...
    UITRIGGER_ALT_INFO_2_SHIELD,
    UITRIGGER_ALT_INFO_2_MAX_SHIELD,
    UITRIGGER_ALT_INFO_2_SHIELD_PERCENT,
    UITRIGGER_ALT_INFO_2_IS_IN_EXP_RANGE,
    ...
    UITRIGGER_ALT_INFO_3_SHIELD,
    UITRIGGER_ALT_INFO_3_MAX_SHIELD,
    UITRIGGER_ALT_INFO_3_SHIELD_PERCENT,
    UITRIGGER_ALT_INFO_3_IS_IN_EXP_RANGE,
    ...
    UITRIGGER_HERO_SELECT_HERO_ALT_AVATAR_LIST,
    UITRIGGER_HERO_SELECT_HERO_HAS_AVATARS,
    ...
    UITRIGGER_HERO_SELECT_NEED_AVATAR_SELECTION,
    UITRIGGER_HERO_SELECT_COINS,
...
private:
    ...
    CHeroDefinition*    GetModifiedHeroDefinitionFromPath(const tstring &sPath, const tstring &sAvatar);
    CHeroDefinition*    GetModifiedHeroDefinition(const tstring &sHeroName, const tstring &sAvatar);
...
public:
    ...
    void    LoadEntityDefinition(const tstring &sPath);

    const tstring&  GetHeroIconPathFromHeroDefinition(const tstring &sPath, const tstring &sAvatar);
    
    const tstring&  GetHeroIconPathFromProduct(const tstring &sProduct);
    const tstring&  GetHeroPreviewModelPathFromProduct(const tstring &sProduct);
    const tstring&  GetHeroPassiveEffectPathFromProduct(const tstring &sProduct);
    CVec3f          GetHeroPreviewPosFromProduct(const tstring &sProduct);
    CVec3f          GetHeroPreviewAnglesFromProduct(const tstring &sProduct);
    float           GetHeroPreviewScaleFromProduct(const tstring &sProduct);
