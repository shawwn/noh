...
//
//=============================================================================
#ifndef __C_TWOPOINTEMITTER_H__
#define __C_TWOPOINTEMITTER_H__
...
// CTwoPointEmitterDef
//=============================================================================
class CTwoPointEmitterDef : public IEmitterDef
{
private:
    // Emitter Properties
    CRangei                     m_riLife;
...
// CTwoPointEmitter
//=============================================================================
class CTwoPointEmitter : public IEmitter
{
private:
...
public:
    virtual ~CTwoPointEmitter();
    CTwoPointEmitter(uint uiStartTime, CParticleSystem *pParticleSystem, IEmitter *pOwner, const CTwoPointEmitterDef &eSettings);
