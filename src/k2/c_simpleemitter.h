...
//
//=============================================================================
#ifndef __C_SIMPLEEMITTER_H__
#define __C_SIMPLEEMITTER_H__
...
// CSimpleEmitterDef
//=============================================================================
class CSimpleEmitterDef : public IEmitterDef
{
private:
	// Emitter Properties
	tstring						m_sOwner;
...
// CSimpleEmitter
//=============================================================================
class CSimpleEmitter : public IEmitter
{
private:
...
public:
	...
	CSimpleEmitter(uint uiStartTime, CParticleSystem *pParticleSystem, IEmitter *pOwner, const CSimpleEmitterDef &eSettings);
