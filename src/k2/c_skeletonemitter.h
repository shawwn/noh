...
//
//=============================================================================
#ifndef __C_SKELETONEMITTER_H__
#define __C_SKELETONEMITTER_H__
...
// CSkeletonEmitterDef
//=============================================================================
class CSkeletonEmitterDef : public IEmitterDef
{
private:
    // Emitter Properties
    tstring                     m_sOwner;
...
// CSkeletonEmitter
//=============================================================================
class CSkeletonEmitter : public IEmitter
{
private:
...
public:
    virtual ~CSkeletonEmitter();
    CSkeletonEmitter(uint uiStartTime, CParticleSystem *pParticleSystem, IEmitter *pOwner, const CSkeletonEmitterDef &eSettings);
