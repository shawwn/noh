...
/*====================
  CSkeletonEmitterDef::~CSkeletonEmitterDef
  ====================*/
CSkeletonEmitterDef::~CSkeletonEmitterDef()
{
}
...
/*====================
  CSkeletonEmitterDef::Spawn
  ====================*/
IEmitter*   CSkeletonEmitterDef::Spawn(uint uiStartTime, CParticleSystem *pParticleSystem, IEmitter *pOwner)
{
    PROFILE("CSkeletonEmitterDef::Spawn");

    return K2_NEW(ctx_Effects, CSkeletonEmitter)(uiStartTime, pParticleSystem, pOwner, *this);
}


/*====================
  CSkeletonEmitter::~CSkeletonEmitter
  ====================*/
CSkeletonEmitter::~CSkeletonEmitter()
{
}
...
/*====================
  CSkeletonEmitter::CSkeletonEmitter
  ====================*/
CSkeletonEmitter::CSkeletonEmitter(uint uiStartTime, CParticleSystem *pParticleSystem, IEmitter *pOwner, const CSkeletonEmitterDef &eSettings) :
IEmitter
(
    eSettings.GetLife(),
...
/*====================
  CSkeletonEmitter::ResumeFromPause
  ====================*/
void    CSkeletonEmitter::ResumeFromPause(uint uiMilliseconds)
{
...
/*====================
  CSkeletonEmitter::Update
  ====================*/
bool    CSkeletonEmitter::Update(uint uiMilliseconds, ParticleTraceFn_t pfnTrace)
{
    PROFILE("CSkeletonEmitter::Update");
    ...
    {
        Console.Warn << m_pParticleSystem->GetEffect()->GetPath() << _T(": <skeletonemitter> iDeltaTime == ") << iDeltaTime << newl;
        iDeltaTime = 0xffff;
    }
#else
    ...
    bool bActive(m_bActive && m_pParticleSystem->GetActive() && m_uiExpireTime == INVALID_TIME);
    ...
    while (m_fAccumulator >= 1.0f && (m_iCount == -1 || m_iSpawnCount < m_iCount))
    {
        ...
        CVec3f  v3SkeletonPos(m_pParticleSystem->GetSourceRandomPositionOnSkeleton());
        ...
        CVec3f  v3Position(TransformPoint(v3OffsetPos + v3SkeletonPos, aLerpedAxis, v3LerpedPos, fLerpedScale));
...
/*====================
  CSkeletonEmitter::GetNumBillboards
  ====================*/
uint    CSkeletonEmitter::GetNumBillboards()
{
    if (m_vParticles.size() == 0)
        return 0;
...
/*====================
  CSkeletonEmitter::GetBillboard
  ====================*/
bool    CSkeletonEmitter::GetBillboard(uint uiIndex, SBillboard &outBillboard)
{
