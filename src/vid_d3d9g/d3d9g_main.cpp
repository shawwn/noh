...
void	D3D_GetDeviceCaps()
{
	...
	LPCSTR szVertex(D3DXGetVertexShaderProfile(g_pd3dDevice));
	LPCSTR szPixel(D3DXGetPixelShaderProfile(g_pd3dDevice));

	d3d_vertexShaderProfile = szVertex != NULL ? StringToTString(szVertex) : TSNULL;
	d3d_pixelShaderProfile = szPixel != NULL ? StringToTString(szPixel) : TSNULL;
