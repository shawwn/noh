...
//=============================================================================
#ifndef __D3D9_STATE_H__
#define __D3D9_STATE_H__
...
bool	D3D_SetVertexShader(IDirect3DVertexShader9 *pShader);
...
bool	D3D_SetPixelShader(IDirect3DPixelShader9 *pShader);
...
{
	// Inform D3D API if the state actually changes
	if (g_TopVertexShader != pShader)
	{
		PROFILE("VertexShader Change");

		// Change the top of the stack to the new shader
...
{
	// Inform D3D API if the state actually changes
	if (g_TopPixelShader != pShader)
	{
		PROFILE("PixelShader Change");
