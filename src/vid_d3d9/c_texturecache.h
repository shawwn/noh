...
public:
    ...
    void    CacheTexture(const tstring &sPath, IDirect3DBaseTexture9 *pTexture, time_t tModTime);
    void    CacheTexture(const tstring &sPath, IDirect3DTexture9 *pTexture, time_t tModTime);
...
public:
    ...
    void    CacheTexture(const tstring &sPath, IDirect3DBaseTexture9 *pTexture);
    void    CacheTexture(const tstring &sPath, IDirect3DBaseTexture9 *pTexture, const tstring &sReference);
