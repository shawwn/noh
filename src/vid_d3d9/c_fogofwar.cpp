...
EXTERN_CVAR_BOOL(d3d_crossFrameCycleBuffer);
//=============================================================================
...
void	CFogofWar::Initialize(uint uiWidth, uint uiHeight, int iSize)
{
	...
	m_hFogofWarTexture = g_ResourceManager.Register(K2_NEW(ctx_D3D9,   CTexture)(_T("$fogofwar"), TEXTURE_2D, TEX_FULL_QUALITY | TEX_NO_MIPMAPS, TEXFMT_A8R8G8B8), RES_TEXTURE);
	m_hFogofWarTexture0 = g_ResourceManager.Register(K2_NEW(ctx_D3D9,   CTexture)(_T("$fogofwar0"), TEXTURE_2D, TEX_FULL_QUALITY | TEX_NO_MIPMAPS, TEXFMT_A8R8G8B8), RES_TEXTURE);
	m_hFogofWarTexture1 = g_ResourceManager.Register(K2_NEW(ctx_D3D9,   CTexture)(_T("$fogofwar1"), TEXTURE_2D, TEX_FULL_QUALITY | TEX_NO_MIPMAPS, TEXFMT_A8R8G8B8), RES_TEXTURE);
...
void	CFogofWar::DrawTexture(float fLerp)
{
	...
	if (!d3d_crossFrameCycleBuffer || g_dwFowQuadBase + 2 >= MAX_FOWQUADS)
		g_dwFowQuadBase = 0;
