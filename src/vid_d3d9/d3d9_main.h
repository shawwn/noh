...
// Direct3D
//=============================================================================
#ifndef __D3D9_MAIN_H__
#define __D3D9_MAIN_H__
...
void    D3D_Notify(int message, const class CWorld &world, int param1, int param2, int param3, const tstring &sResContext);
...
extern  IDirect3DDevice9Ex      *g_pd3dDeviceEx;
...
extern  D3DXMATRIXA16           g_mWorldOffset;
...
extern D3DPOOL                  g_d3dManagedPool;
extern DWORD                    g_d3dManagedUsage;

extern bool                     g_bD3D9Ex;
...
struct SDeviceCaps
{
    // shader support
    bool    bShaders;
    DWORD   dwMaxPixelShaderVersion;
    DWORD   dwMaxVertexShaderVersion;
