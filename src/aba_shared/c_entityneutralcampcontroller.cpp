...
/*====================
  ...
  ====================*/
void	CEntityNeutralCampController::ClientPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
...
/*====================
  ...
  ====================*/
void	CEntityNeutralCampController::ServerPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
}
