...
void    ISlaveDefinition::ReadSettings(ISlaveDefinition *pDefinition, const CXMLNode &node, bool bMod)
{
    ...
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(HealthProportionRegen, healthproportionregen)
    ...
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(ManaProportionRegen, manaproportionregen)
    ...
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(MaxStamina, maxstamina)
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(MaxStaminaMultiplier, maxstaminamultiplier)
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(StaminaRegen, staminaregen)
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(StaminaProportionRegen, staminaproportionregen)
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(StaminaRegenMultiplier, staminaregenmultiplier)
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(StaminaRegenPercent, staminaregenpercent)
    ...
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(StaminaRegenReduction, staminaregenreduction)
    ...
    READ_ENTITY_DEFINITION_PROGRESSIVE_PROPERTY(Power, power)
}
...
ENTITY_DEF_MERGE_START(ISlaveDefinition, IEntityDefinition)
    ...
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(HealthProportionRegen)
    ...
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(ManaProportionRegen)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(ManaRegenMultiplier)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(ManaRegenPercent)

    MERGE_PROGRESSIVE_ARRAY_PROPERTY(MaxStamina)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(MaxStaminaMultiplier)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegen)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(StaminaProportionRegen)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenMultiplier)
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenPercent)
    ...
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenReduction)
    ...
    MERGE_PROGRESSIVE_ARRAY_PROPERTY(Power)
