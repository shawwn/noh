...
void	IUnitDefinition::ReadSettings(IUnitDefinition *pDefinition, const CXMLNode &node, bool bMod)
{
	...
	READ_ENTITY_DEFINITION_PROPERTY_EX(SprintAnim, sprintanim, sprint_1)
	...
	READ_ENTITY_DEFINITION_PROPERTY(StaminaRegenReduction, staminaregenreduction)
	...
	READ_ENTITY_DEFINITION_PROPERTY(SprintMoveSpeedBonus, sprintmovespeedbonus)
	READ_ENTITY_DEFINITION_PROPERTY(SprintMoveSpeedMultiplier, sprintmovespeedmultiplier)
	READ_ENTITY_DEFINITION_PROPERTY(SprintStaminaCost, sprintstaminacost)
...
ENTITY_DEF_MERGE_START(IUnitDefinition, IEntityDefinition)
	...
	MERGE_STRING_PROPERTY(SprintAnim)
	...
	MERGE_ARRAY_PROPERTY(StaminaRegenReduction)
	...
	MERGE_ARRAY_PROPERTY(SprintMoveSpeedBonus)
	MERGE_ARRAY_PROPERTY(SprintMoveSpeedMultiplier)
	MERGE_ARRAY_PROPERTY(SprintStaminaCost)
