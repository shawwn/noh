...
BEGIN_XML_REGISTRATION(name) \
	REGISTER_XML_PROCESSOR(onframe) \
	REGISTER_XML_PROCESSOR(onframeimpact) \
	REGISTER_XML_PROCESSOR(oninterval) \
	REGISTER_XML_PROCESSOR(onbegin) \
	REGISTER_XML_PROCESSOR(onstart) \
	REGISTER_XML_PROCESSOR(onprecost) \
	REGISTER_XML_PROCESSOR(onaction) \
	REGISTER_XML_PROCESSOR(onpreimpact) \
	REGISTER_XML_PROCESSOR(onpredamage) \
	REGISTER_XML_PROCESSOR(ondamageevent) \
	REGISTER_XML_PROCESSOR(ondoubleactivate) \
	REGISTER_XML_PROCESSOR(onimpact) \
	REGISTER_XML_PROCESSOR(onimpactinvalid) \
	REGISTER_XML_PROCESSOR(oncomplete) \
	REGISTER_XML_PROCESSOR(oncancel) \
	REGISTER_XML_PROCESSOR(onactivatestart) \
	REGISTER_XML_PROCESSOR(onactivateprecost) \
	REGISTER_XML_PROCESSOR(onactivatepreimpact) \
	REGISTER_XML_PROCESSOR(onactivateimpact) \
	REGISTER_XML_PROCESSOR(onactivateend) \
	REGISTER_XML_PROCESSOR(onabilitystart) \
	REGISTER_XML_PROCESSOR(onabilityimpact) \
	REGISTER_XML_PROCESSOR(onabilityfinish) \
	REGISTER_XML_PROCESSOR(onabilityend) \
	REGISTER_XML_PROCESSOR(ontoggleon) \
	REGISTER_XML_PROCESSOR(ontoggleoff) \
	REGISTER_XML_PROCESSOR(onchannelstart) \
	REGISTER_XML_PROCESSOR(onchannelframe) \
	REGISTER_XML_PROCESSOR(onchannelbreak) \
	REGISTER_XML_PROCESSOR(onchannelend) \
	REGISTER_XML_PROCESSOR(onchannelingstart) \
	REGISTER_XML_PROCESSOR(onchannelingframe) \
	REGISTER_XML_PROCESSOR(onchannelingbreak) \
	REGISTER_XML_PROCESSOR(onchannelingend) \
	REGISTER_XML_PROCESSOR(onattackstart) \
	REGISTER_XML_PROCESSOR(onattack) \
	REGISTER_XML_PROCESSOR(onattackpreimpact) \
	REGISTER_XML_PROCESSOR(onattackpredamage) \
	REGISTER_XML_PROCESSOR(onattackdamageevent) \
	REGISTER_XML_PROCESSOR(onattackimpact) \
	REGISTER_XML_PROCESSOR(onattackimpactinvalid) \
	REGISTER_XML_PROCESSOR(onattackend) \
	REGISTER_XML_PROCESSOR(onattackedstart) \
	REGISTER_XML_PROCESSOR(onattackedpreimpact) \
	REGISTER_XML_PROCESSOR(onattackedpredamage) \
	REGISTER_XML_PROCESSOR(onattackeddamageevent) \
	REGISTER_XML_PROCESSOR(onattackedpostimpact) \
	REGISTER_XML_PROCESSOR(onattackingstart) \
	REGISTER_XML_PROCESSOR(onattackingpreimpact) \
	REGISTER_XML_PROCESSOR(onattackingpredamage) \
	REGISTER_XML_PROCESSOR(onattackingdamageevent) \
	REGISTER_XML_PROCESSOR(onattackingpostimpact) \
	REGISTER_XML_PROCESSOR(ondamage) \
	REGISTER_XML_PROCESSOR(ondamaged) \
	REGISTER_XML_PROCESSOR(onstunned) \
	REGISTER_XML_PROCESSOR(onkilled) \
	REGISTER_XML_PROCESSOR(onexpired) \
	REGISTER_XML_PROCESSOR(ondeath) \
	REGISTER_XML_PROCESSOR(onkill) \
	REGISTER_XML_PROCESSOR(onindirectkill) \
	REGISTER_XML_PROCESSOR(onspawn) \
	REGISTER_XML_PROCESSOR(onrespawn) \
	REGISTER_XML_PROCESSOR(oninflict) \
	REGISTER_XML_PROCESSOR(onrefresh) \
	REGISTER_XML_PROCESSOR(oninflicted) \
	REGISTER_XML_PROCESSOR(onownerrespawn) \
	REGISTER_XML_PROCESSOR(onrelease) \
	REGISTER_XML_PROCESSOR(ontouch) \
	REGISTER_XML_PROCESSOR(ontouched) \
	REGISTER_XML_PROCESSOR(onthink) \
	REGISTER_XML_PROCESSOR(ontargetacquired) \
	REGISTER_XML_PROCESSOR(onlearn) \
	REGISTER_XML_PROCESSOR(onupgrade) \
	REGISTER_XML_PROCESSOR(oncreate) \
	REGISTER_XML_PROCESSOR(onpurchase) \
	REGISTER_XML_PROCESSOR(ontimer) \
	REGISTER_XML_PROCESSOR(onpickup) \
	REGISTER_XML_PROCESSOR(onlobbystart) \
	REGISTER_XML_PROCESSOR(onaddplayer) \
	REGISTER_XML_PROCESSOR(onentergame) \
...
BEGIN_COMBAT_ACTION_LEAF_XML_PROCESSOR(damage, CCombatActionDamage)
	if (node.HasProperty(_T("min")) && node.HasProperty(_T("max")))
	{
		pAction->SetMinDamage(node.GetProperty(_T("min")));
		pAction->SetMaxDamage(node.GetProperty(_T("max")));
	}
	else
	{
		pAction->SetMinDamage(node.GetProperty(_T("amount")));
		pAction->SetMaxDamage(node.GetProperty(_T("amount")));
	}
	READ_COMBAT_ACTION_PROPERTY(EffectType, effecttype)
