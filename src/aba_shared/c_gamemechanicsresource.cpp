...
{
	return K2_NEW(g_heapResources,    CGameMechanicsResource)(sPath);
}

IResourceLibrary	g_ResLibGameMechanics(RES_GAME_MECHANICS, _T("Game Mechanics"), true, AllocGameMechanics);
//=============================================================================
