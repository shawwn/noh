...
/*====================
  ...
  ====================*/
void    IAffector::ClientPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
...
/*====================
  ...
  ====================*/
void    IAffector::ServerPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
