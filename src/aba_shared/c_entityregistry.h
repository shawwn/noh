...
public:
    ...
    CEntityAllocator(const tstring &sName, ushort unID) : IEntityAllocator(sName, unID)
    {
        ...
        m_pBaseline = K2_NEW(g_heapEntity,    CEntitySnapshot)();
    ...
    virtual void                        ClientPrecache(EPrecacheScheme eScheme) const   { T::ClientPrecache(NULL, eScheme); }
    virtual void                        ServerPrecache(EPrecacheScheme eScheme) const   { T::ServerPrecache(NULL, eScheme); }
...
IGameEntity*    CEntityAllocator<T>::Allocate() const
{
    try
    {
        T* pNewEnt(K2_NEW(g_heapEntity,    T)());
        if (pNewEnt == NULL)
...
public:
    ...
    virtual const SEntityDesc*          GetTypeDesc() const     { return T::GetStaticTypeDesc(); }
    virtual uint                        GetVersion() const      { return T::GetVersion(); }
    virtual void                        ClientPrecache(EPrecacheScheme eScheme) const   { T::ClientPrecache(T::GetEntityConfig(), eScheme); }
    virtual void                        ServerPrecache(EPrecacheScheme eScheme) const   { T::ServerPrecache(T::GetEntityConfig(), eScheme); }
...
public:
    ...
    virtual IGameEntity*            Allocate() const        { return K2_NEW(g_heapEntity,    T); }
    virtual const TypeVector*       GetTypeVector() const   { return &T::GetTypeVector(); }
    virtual const SEntityDesc*      GetTypeDesc() const     { return T::GetStaticTypeDesc(); }
    virtual uint                    GetVersion() const      { return T::GetVersion(); }
    virtual void                    ClientPrecache(EPrecacheScheme eScheme) const   { T::ClientPrecache(NULL, eScheme); }
...
public:
    ...
    void                        ClientPrecache(EPrecacheScheme eScheme) const       { if (m_pBaseAllocator != NULL) m_pBaseAllocator->ClientPrecache(eScheme); }
    void                        ServerPrecache(EPrecacheScheme eScheme) const       { if (m_pBaseAllocator != NULL) m_pBaseAllocator->ServerPrecache(eScheme); }
...
public:
    ...
    GAME_SHARED_API void                ServerPrecache(ushort unType, EPrecacheScheme eScheme) const;
    GAME_SHARED_API void                ClientPrecache(ushort unType, EPrecacheScheme eScheme) const;
    ...
    T*  GetDefinition(ushort unTypeID)
    {
        ...
        CEntityDefinitionResource *pResource(g_ResourceManager.Get<CEntityDefinitionResource>(itFind->second.GetDefinitionHandle()));
        if (pResource == NULL)
            return NULL;
