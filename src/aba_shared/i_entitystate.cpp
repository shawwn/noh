...
/*====================
  ...
  ====================*/
void    IEntityState::ClientPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
    ISlaveEntity::ClientPrecache(pConfig, eScheme);
...
/*====================
  ...
  ====================*/
void    IEntityState::ServerPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme)
{
    ISlaveEntity::ServerPrecache(pConfig, eScheme);
