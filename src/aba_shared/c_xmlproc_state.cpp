...
START_ENTITY_DEFINITION_XML_PROCESSOR(IEntityState, State)
    ...
    READ_ENTITY_DEFINITION_MUTATION(HealthProportionRegen, healthproportionregen)
    READ_ENTITY_DEFINITION_MUTATION(MaxMana, maxmana)
    READ_ENTITY_DEFINITION_MUTATION(ManaRegen, manaregen)
    READ_ENTITY_DEFINITION_MUTATION(ManaProportionRegen, manaproportionregen)
    READ_ENTITY_DEFINITION_MUTATION(MaxStamina, maxstamina)
    READ_ENTITY_DEFINITION_MUTATION(StaminaRegen, staminaregen)
    READ_ENTITY_DEFINITION_MUTATION(StaminaProportionRegen, staminaproportionregen)
    ...
    READ_ENTITY_DEFINITION_MUTATION(StaminaRegenReduction, staminaregenreduction)
    ...
    READ_ENTITY_DEFINITION_MUTATION(Power, power)
...
ENTITY_DEF_MERGE_START(CStateDefinition, ISlaveDefinition)
    ...
    MERGE_ARRAY_MUTATION(HealthProportionRegen)
    MERGE_ARRAY_MUTATION(MaxMana)
    MERGE_ARRAY_MUTATION(ManaRegen)
    MERGE_ARRAY_MUTATION(ManaProportionRegen)
    MERGE_ARRAY_MUTATION(MaxStamina)
    MERGE_ARRAY_MUTATION(StaminaRegen)
    MERGE_ARRAY_MUTATION(StaminaProportionRegen)
    ...
    MERGE_ARRAY_MUTATION(StaminaRegenReduction)
