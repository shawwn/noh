...
class ISlaveDefinition : public IEntityDefinition
{
    ...
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(MaxStaminaMultiplier, float)
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegen, float)
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(StaminaProportionRegen, float)
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenMultiplier, float)
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenPercent, float)
    ...
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(StaminaRegenReduction, float)
