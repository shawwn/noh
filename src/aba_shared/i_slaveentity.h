...
public:
	...
	virtual ushort		GetCharges() const			{ return m_unCharges; }
	virtual void		SetCharges(uint uiCharges)	{ m_unCharges = uiCharges; }
	virtual void		RemoveCharge()				{ if (m_unCharges > 0) --m_unCharges; }
	virtual void		AddCharges(uint uiCharges)	{ if (GetMaxCharges() == -1) m_unCharges += uiCharges; else m_unCharges = MIN<int>(m_unCharges + uiCharges, GetMaxCharges()); }
	...
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, HealthProportionRegen)
	...
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, ManaProportionRegen)
	...
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, MaxStamina)
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, MaxStaminaMultiplier)
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, StaminaRegen)
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, StaminaProportionRegen)
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, StaminaRegenMultiplier)
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, StaminaRegenPercent)
	...
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, StaminaRegenReduction)
	...
	PROGRESSIVE_MULTI_LEVEL_ENTITY_DEFINITION_ACCESSOR(float, Power)
