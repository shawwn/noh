...
public:
    ...
    virtual uint            GetResType() const          { return RES_TREE; }
    virtual const tstring&  GetResTypeName() const      { return ResTypeName(); }
    static const tstring&   ResTypeName()               { static tstring sTypeName(_T("{tree}")); return sTypeName; }
