...
// Definitions
//=============================================================================
DEFINE_ENT_ALLOCATOR2(Player, Engineer);
//=============================================================================

/*====================
  CPlayerEngineer::CEntityConfig::CEntityConfig
  ====================*/
CPlayerEngineer::CEntityConfig::CEntityConfig(const tstring &sName) :
...
/*====================
  CPlayerEngineer::CPlayerEngineer
  ====================*/
CPlayerEngineer::CPlayerEngineer() :
...
/*====================
  CPlayerEngineer::SetupBuildModeCamera
  ====================*/
void    CPlayerEngineer::SetupBuildModeCamera(CCamera &camera, CVec3f v3InputAngles, float fLerp)
{
...
/*====================
  CPlayerEngineer::SetupCamera
  ====================*/
void    CPlayerEngineer::SetupCamera(CCamera &camera, const CVec3f &v3InputPosition, const CVec3f &v3InputAngles)
{
