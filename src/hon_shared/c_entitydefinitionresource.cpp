...
{
    return K2_NEW(ctx_Game,    CEntityDefinitionResource)(sPath);
}

IResourceLibrary    g_ResLibEntityDefinition(RES_ENTITY_DEF, _T("Entity Definitions"), CEntityDefinitionResource::ResTypeName(), true, AllocEntityDefinition);
//=============================================================================
