...
public: \
	...
	static const tstring&	GetBaseTypeName()	{ static const tstring *sBaseTypeName = K2_NEW(ctx_Game,   tstring)(_T(#name)); return *sBaseTypeName; } \
...
protected:
	...
	GAME_SHARED_API CEntityDefinitionResource*	GetEntityDef(ResHandle hEntDef) const;
...
public:
	...
	DECLARE_SUB_ENTITY_ACCESSOR(IEntityStateNetAccum, StateNetAccum)
