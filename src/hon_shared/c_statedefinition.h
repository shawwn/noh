...
class CStateDefinition : public ISlaveDefinition
{
    ...
    ENT_DEF_ARRAY_PROPERTY(ServerEntity, bool)
    ...
    ENT_DEF_ARRAY_MUTATION(AlwaysTransmitData, bool)
...
protected:
    ...
    {
        ISlaveDefinition::PrecacheV(eScheme, sModifier);
        ...
        PRECACHE_GUARD
            ...
            PRECACHE_ENTITY_ARRAY(MorphAttackProjectile, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory0, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory1, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory2, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory3, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory4, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory5, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory6, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory7, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphInventory8, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(MorphSharedInventory0, eScheme, sModifier);
            PRECACHE_ENTITY_ARRAY(MorphSharedInventory1, eScheme, sModifier);
            PRECACHE_ENTITY_ARRAY(MorphSharedInventory2, eScheme, sModifier);
        PRECACHE_GUARD_END
    }

    virtual void    GetPrecacheListV(EPrecacheScheme eScheme, const tstring &sModifier, HeroPrecacheList &deqPrecache)
    {
        ISlaveDefinition::GetPrecacheListV(eScheme, sModifier, deqPrecache);

        PRECACHE_GUARD
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphAttackProjectile, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory0, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory1, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory2, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory3, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory4, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory5, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory6, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory7, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphInventory8, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphSharedInventory0, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphSharedInventory1, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(MorphSharedInventory2, eScheme, sModifier, deqPrecache)
        PRECACHE_GUARD_END
    }
...
public:
    ...
    {}
    CStateDefinition(IBaseEntityAllocator *pAllocator) :
    ISlaveDefinition(pAllocator)
    {}

    static void     ReadSettings(CStateDefinition *pDefinition, const class CXMLNode &node, bool bMod);

    IEntityDefinition*  GetCopy() const { return K2_NEW(ctx_Game, CStateDefinition)(*this); }
