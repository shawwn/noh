...
/*====================
  IVisualEntity::DrawOutlineOnMap
  ====================*/
void    IVisualEntity::DrawOutlineOnMap(CUITrigger &minimap, CPlayer *pLocalPlayer) const
{
    if (!IsVisibleOnMap(pLocalPlayer))
        return;
    if (GetMapIcon(pLocalPlayer) == INVALID_RESOURCE)
...
/*====================
  ...
  ====================*/
void    IVisualEntity::ClientPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme, const tstring &sModifier)
{
...
/*====================
  ...
  ====================*/
void    IVisualEntity::ServerPrecache(CEntityConfig *pConfig, EPrecacheScheme eScheme, const tstring &sModifier)
{
