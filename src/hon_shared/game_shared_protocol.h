...
const byte GAME_CMD_RIVAL_MESSAGE				(0x7a);
const byte GAME_CMD_PAYBACK_MESSAGE				(0x7b);
...
const byte GAME_CMD_SELECT_AVATAR				(0xc9);
const byte GAME_CMD_FIRST_BLOOD_MESSAGE2		(0xd0);
const byte GAME_CMD_RAGE_QUIT_MESSAGE2			(0xd1);
const byte GAME_CMD_SMACKDOWN_MESSAGE2			(0xd2);
const byte GAME_CMD_HUMILIATION_MESSAGE2		(0xd3);
const byte GAME_CMD_DENY_TOWER_MESSAGE2			(0xd4);
const byte GAME_CMD_TEAM_WIPE_MESSAGE2			(0xd5);
const byte GAME_CMD_KILLSTREAK_MESSAGE2			(0xd6);
const byte GAME_CMD_MULTIKILL_MESSAGE2			(0xd7);
const byte GAME_CMD_UNIT_PING					(0xd8);
const byte GAME_CMD_LOBBY_CONNECT_MESSAGE2		(0xd9);
const byte GAME_CMD_REFRESH_UPGRADES			(0xda);
const byte GAME_CMD_PAUSE_COUNTDOWN				(0xdb);
