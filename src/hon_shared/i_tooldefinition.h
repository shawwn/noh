...
class IToolDefinition : public ISlaveDefinition
{
    ...
    ENT_DEF_ARRAY_PROPERTY(NoStun, bool)
    ...
    ENT_DEF_ARRAY_PROPERTY(NoTurnToTarget, bool)
...
protected:
    virtual void    PrecacheV(EPrecacheScheme eScheme, const tstring &sModifier)
    {
        ...
        PRECACHE_GUARD
            PRECACHE_ENTITY_ARRAY(Projectile, eScheme, sModifier)
            PrecacheCastEffect();
    ...
    virtual void    GetPrecacheListV(EPrecacheScheme eScheme, const tstring &sModifier, HeroPrecacheList &deqPrecache)
    {
        ...
        PRECACHE_GUARD
            GET_ENTITY_ARRAY_PRECACHE_LIST(Projectile, eScheme, sModifier, deqPrecache)
        PRECACHE_GUARD_END
    }
