...
class IUnitDefinition : public IEntityDefinition
{
    ...
    ENT_DEF_PROPERTY(HoverOnMap, bool)
    ...
    ENT_DEF_ARRAY_PROPERTY(HealthRegen, float)
    ENT_DEF_PROGRESSIVE_ARRAY_PROPERTY(MaxMana, float)
    ENT_DEF_ARRAY_PROPERTY(ManaRegen, float)
    ...
    ENT_DEF_ARRAY_PROPERTY(MagicArmor, float)
    ...
    ENT_DEF_ARRAY_PROPERTY(UnsharedExperienceBounty, float)
    ...
    ENT_DEF_ARRAY_PROPERTY(LargeUnit, bool)
...
protected:
    virtual void    PrecacheV(EPrecacheScheme eScheme, const tstring &sModifier)
    {
        ...
        PRECACHE_GUARD
            ...
            PRECACHE_ENTITY_ARRAY(Inventory0, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory1, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory2, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory3, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory4, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory5, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory6, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory7, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(Inventory8, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(SharedInventory0, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(SharedInventory1, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(SharedInventory2, eScheme, sModifier)
            PRECACHE_ENTITY_ARRAY(AttackProjectile, eScheme, sModifier)
        PRECACHE_GUARD_END
    }
    ...
    virtual void    GetPrecacheListV(EPrecacheScheme eScheme, const tstring &sModifier, HeroPrecacheList &deqPrecache)
    {
        ...
        PRECACHE_GUARD
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory0, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory1, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory2, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory3, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory4, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory5, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory6, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory7, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(Inventory8, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(SharedInventory0, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(SharedInventory1, eScheme, sModifier, deqPrecache)
            GET_ENTITY_ARRAY_PRECACHE_LIST(SharedInventory2, eScheme, sModifier, deqPrecache)
        PRECACHE_GUARD_END
    }
