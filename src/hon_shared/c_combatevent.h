...
public:
	...
	void	SetArmorPierce(float fArmorPierce)				{ m_fArmorPierce = fArmorPierce; }
	float	GetArmorPierce() const							{ return m_fArmorPierce; }

	void	SetMagicArmorPierce(float fMagicArmorPierce)	{ m_fMagicArmorPierce = fMagicArmorPierce; }
